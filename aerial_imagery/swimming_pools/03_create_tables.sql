...
-- create image, label and output tables
...
drop table if exists data_science.swimming_pool_detects;
create table data_science.swimming_pool_detects (
   file_path text NOT NULL,
   label_type text NOT NULL,
   legal_parcel_id text,
   gnaf_pid text,
...
alter table data_science.swimming_pool_detects owner to "ec2-user";

-- TODO: move these to after data import if this needs to scale
CREATE INDEX swimming_pool_detects_file_path_idx ON data_science.swimming_pool_detects USING btree (file_path);
CREATE INDEX swimming_pool_detects_point_geom_idx ON data_science.swimming_pool_detects USING gist (point_geom);
CREATE INDEX swimming_pool_detects_geom_idx ON data_science.swimming_pool_detects USING gist (geom);
ALTER TABLE data_science.swimming_pool_detects CLUSTER ON swimming_pool_detects_geom_idx;